...
/*we have to create a loop that takes the lowest
 number that has been seen in the loop
and compares it to the following numbers.
if another number is lower the first number must be replaced

if there is only one number in the string we must return that number


we then must return the lowest number.
*/
